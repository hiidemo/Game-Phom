...
Original file is located at
    https://colab.research.google.com/drive/1bRj8Q6j5KQ5Ip5Gqahv3fh7vHQHHtapw
"""
...
count,per1 = numbaMain(numbaRandomBot,numbaRandomBot,numbaRandomBot,numbaRandomBot,1000000,perx)
print(count)